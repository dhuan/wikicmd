...
func Execute() error {
	...
	importCmd.Flags().StringVarP(&flagMessage, "message", "m", "", "Summary for the page you're importing.")
	editCmd.Flags().StringVarP(&flagMessage, "message", "m", "", "Summary for your change.")
